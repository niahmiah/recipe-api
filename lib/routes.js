...
router.get('/meal/:id', router.oauth.authorise(), get(Meal));

router.post('/foodItem', router.oauth.authorise(), post(FoodItem));
router.post('/meal', router.oauth.authorise(), post(Meal));
router.post('/recipe', router.oauth.authorise(), post(Recipe));

router.delete('/meal/:id', router.oauth.authorise(), del(Meal));
